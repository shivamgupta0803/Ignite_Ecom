...
//     // Filter products to create a cart
//   };
...
//       totalPrice: quantities[i] * prod.discount_price,
//     }))
//     .filter((item) => item.quantity > 0);

//   // console.log("Products with quantity:", quantities);
...
//   // Generate the cart based on products with quantities > 0
//   const cart = products
//     .map((prod: any, i: number) => ({
//       ...prod,
//       quantity: quantities[i],
