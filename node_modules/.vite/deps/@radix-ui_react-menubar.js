...
import {
  createCollection,
  useDirection
} from "./chunk-HJIJV3Q4.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-CGLMBF7Z.js";
import {
  Anchor,
  Arrow,
  Content,
  Root2,
  createPopperScope
} from "./chunk-YEDITBBQ.js";
import {
  Portal
} from "./chunk-ULUWHR2H.js";
import {
  DismissableLayer,
  Presence,
  ...
  useId
} from "./chunk-XL2JRHUH.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-OL77LGYK.js";
import {
  Slot,
  composeRefs,
  useComposedRefs
} from "./chunk-QBMH5CFD.js";
import {
  require_jsx_runtime
...
var Menubar = React4.forwardRef(
  (props, forwardedRef) => {
    ...
    const [currentTabStopId, setCurrentTabStopId] = React4.useState(null);
    return (0, import_jsx_runtime4.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React4.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React4.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React4.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime4.jsx)(Collection3.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime4.jsx)(Collection3.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime4.jsx)(
          Root,
          {
            asChild: true,
            ...rovingFocusGroupScope,
            ...
            children: (0, import_jsx_runtime4.jsx)(Primitive.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React4.useRef(false);
...
var MenubarTrigger = React4.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsx)(Collection3.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime4.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime4.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime4.jsx)(
          Primitive.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarContent = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React4.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React4.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React4.forwardRef(
  (props, forwardedRef) => {
