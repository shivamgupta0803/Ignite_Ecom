...
function PrefetchPageLinksImpl({
  ...
  if (!future.unstable_singleFetch) {
    linksToRender = dataHrefs.map((href) => React8.createElement("link", _extends3({
      key: href,
      rel: "prefetch",
      as: "fetch",
      href
    ...
    if (url.searchParams.get("_routes") !== "") {
      linksToRender = React8.createElement("link", _extends3({
  ...
  return React8.createElement(React8.Fragment, null, linksToRender, moduleHrefs.map((href) => React8.createElement("link", _extends3({
    key: href,
    rel: "modulepreload",
    href
