...
async function resolveConfig(appConfig, {
  ...
  var _appConfig$future, _appConfig$future2, _appConfig$future3, _appConfig$future4, _appConfig$future5, _appConfig$future6, _appConfig$future7;
  ...
  if (isSpaMode && ((_appConfig$future2 = appConfig.future) === null || _appConfig$future2 === void 0 ? void 0 : _appConfig$future2.unstable_lazyRouteDiscovery) === true) {
    throw new Error("You can not use `future.unstable_lazyRouteDiscovery` in SPA Mode (`ssr: false`)");
  }
  ...
  let future = {
    ...
    unstable_singleFetch: ((_appConfig$future6 = appConfig.future) === null || _appConfig$future6 === void 0 ? void 0 : _appConfig$future6.unstable_singleFetch) === true,
    unstable_lazyRouteDiscovery: ((_appConfig$future7 = appConfig.future) === null || _appConfig$future7 === void 0 ? void 0 : _appConfig$future7.unstable_lazyRouteDiscovery) === true
  };
  if (appConfig.future) {
